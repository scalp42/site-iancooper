...
SyntaxHighlighter.brushes.VGL = ->
  ...
  keywords = new RegExp '(' + [
    ...
    'READ_LOCK', 'REMOVED', 'REPEAT', 'RESERVE', 'RESTORE', 'RESULT',
    'STATUS', 'RESULT_AUTHORISE', 'RESULT_DISPLAY', 'RESULT_ENTRY',
    'RESULT_STRING', 'RESULT_VALUE', 'RETURN', 'RETURNING',
    'RIGHTSTRING', 'ROLLBACK', 'ROUND', 'ROUTINE', 'SAMPLE',
    'SAMPLE_STATUS', 'SCREEN', 'SCROLL', 'SELECT', 'SEND', 'SET',
    'SIN', 'SLEEP', 'SPAWN', 'SPLITWORDS', 'SQRT', 'STANDARD_LIBRARY',
    'START', 'STATUS', 'STATUS_CHECK_SUPPRESS', 'STRING',
    'STRINGLENGTH', 'STRIP', 'SUBSTITUTE', 'SUBSTRING', 'SUM',
    'SYMBOL', 'SYNTAX', 'TABLES', 'TAN', 'TEST', 'TEST', 'PAGE',
    ...
    'UNTIL', 'UPDATE', 'USING', 'VALUE', 'WAIT', 'WAKEUP',
    'WAKE_UP_BACKGROUND', 'WHERE', 'WHILE', 'WIDTH', 'WINDOW',
    'WINDOWS', 'WITH', 'WRITE', 'WRITE_ARRAY'
  ].join('|') + ')', 'gm'
