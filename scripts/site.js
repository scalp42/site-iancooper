...
var addemails, convertgist, convertimg, find, load, markup, posts, replaceall, routing, sanitize, show, time_zones, vglize;
  ...
  if (id != null) {
    return load("https://api.github.com/gists/" + id[1], 'jsonp', function(data) {
      ...
      if (data.data.files != null) {
        ...
        return gist.replaceWith("<code>&raquo;&nbsp;</code><a href=\"https://gist.github.com/" + id[1] + "#file-" + (file.replace(/\./g, '-')) + "\"><code>" + file + "</code></a>");
      }
    });
  }
};
...
show = function(post) {
  ...
  if (!post.html) {
    ...
    $('img[src^="gist:"]', container).each(function() {
